...
const Home = props => {
  return (
    <Container style={{ alignItems: "center" }}>
      <NavBar navigation={props.navigation} title="Contribution" />
      <View style={styles.containerDetail}>
        ...
        <View>
          ...
          <View style={{ flexDirection: "row", alignItems: "flex-end" }}>
            <PText bold color="accent" size="sm">
              $0.75
            </PText>
            <PText bold color="accent" size="xs">
              {" "}
              Contributed
            </PText>
          </View>
          <View style={{ flexDirection: "row", marginTop: 5 }}>
            <PTag color={DARK_TEXT} bg={TABLET_BG_COLOR}>
              Water Supplies
            </PTag>
            <PTag color={DARK_TEXT} bg={TABLET_BG_COLOR}>
              Food
